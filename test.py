...
def gen(context):
    r = text_generator(context, max_length=400, do_sample=True, top_p=0.9,
                       pad_token_id=50256, clean_up_tokenization_spaces=True)
    ...
    if model_path:
        ...
        if args.adaption_type != 'finetune':
            model = AutoModelForCausalLM.from_pretrained(
                'uer/gpt2-chinese-cluecorpussmall').to(device)
        ...
        testnum = 2 if args.domain == 'gongwen' else 30
